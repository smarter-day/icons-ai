...
- **639 иконок** добавлены в основной набор (`icon_browser/icons-data.js`)
- **124 иконки** имеют обучающие данные в `icons_data/`
- Кандидаты для отбора: **~3565** иконок в `icon_browser/candidates-data.js`
...
**Текущий счётчик:** последний скрипт — `gen_icons_392_403.py`, следующий начинается с **404**.
