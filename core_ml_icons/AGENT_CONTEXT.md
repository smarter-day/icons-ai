...
- **687 иконок** добавлены в основной набор (`icon_browser/icons-data.js`)
- **172 иконки** имеют обучающие данные в `icons_data/`
- Кандидаты для отбора: **~3517** иконок в `icon_browser/candidates-data.js`
...
**Текущий счётчик:** последний скрипт — `gen_icons_441_451.py`, следующий начинается с **452**.
