...
- **627 иконок** добавлены в основной набор (`icon_browser/icons-data.js`)
- **112 иконок** имеют обучающие данные в `icons_data/`
- Кандидаты для отбора: **~3577** иконок в `icon_browser/candidates-data.js`
...
**Текущий счётчик:** последний скрипт — `gen_icons_379_391.py`, следующий начинается с **392**.
