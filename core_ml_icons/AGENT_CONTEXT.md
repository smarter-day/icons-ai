...
- **700 иконок** добавлены в основной набор (`icon_browser/icons-data.js`)
- **185 иконок** имеют обучающие данные в `icons_data/`
- Кандидаты для отбора: **~3504** иконок в `icon_browser/candidates-data.js`
...
**Текущий счётчик:** последний скрипт — `gen_icons_452_464.py`, следующий начинается с **465**.
