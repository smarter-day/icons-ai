...
- **602 иконки** добавлены в основной набор (`icon_browser/icons-data.js`)
- **87 иконок** имеют обучающие данные в `icons_data/`
- Кандидаты для отбора: **~3602** иконок в `icon_browser/candidates-data.js`
...
**Текущий счётчик:** последний скрипт — `gen_icons_354_366.py`, следующий начинается с **367**.
