...
OUTPUT_EMBEDDINGS_FILE_JSON = "../data/icon_embeddings.json"  # Output embeddings in JSON format
...
def generate_embeddings():
    ...
    # Convert embeddings to a list of lists (JSON-compatible)
    embeddings_list = icon_embeddings.tolist()

    # Save to JSON
    with open(OUTPUT_EMBEDDINGS_FILE_JSON, "w", encoding="utf-8") as f:
        json.dump(embeddings_list, f)
    print(f"Converted {OUTPUT_EMBEDDINGS_FILE} to {OUTPUT_EMBEDDINGS_FILE_JSON}")
